<?php
echo "<tr><td><p><h4><img src=image/b_group.png> STORE</h4></p></td></tr>";
$d=mysql_query("select * from posting where id_kategori='2' order by id_posting desc ");
$n=mysql_num_rows($d);
while ($r=mysql_fetch_array($d))
{
	
	$kat=mysql_fetch_array(mysql_query("select * from kategori where id_kategori='$r[id_kategori]'"));
	echo "<tr><td><span><img src='image/new_struct.png'> <a href=?read=$r[judul_seo]>$kat[nama_kategori]|$r[judul]</a></span>"; 
